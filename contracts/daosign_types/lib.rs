...
mod daosign_types {
    ...
    static EIP712DOMAIN_TYPEHASH: [u8; 32] = [
        139, 115, 195, 198, 155, 184, 254, 61, 81, 46, 204, 76, 247, 89, 204, 121, 35, 159, 123,
        23, 155, 15, 250, 202, 169, 167, 93, 82, 43, 57, 64, 15,
    ];
    ...
    static PROOF_OF_AUTHORITY_TYPEHASH: [u8; 32] = [
        157, 240, 238, 100, 52, 126, 69, 120, 179, 231, 89, 1, 129, 99, 110, 234, 211, 144, 165,
        157, 35, 179, 74, 111, 235, 144, 166, 180, 175, 24, 244, 124,
    ];
    ...
    static PROOF_OF_SIGNATURE_TYPEHASH: [u8; 32] = [
        121, 27, 217, 70, 217, 77, 222, 106, 102, 69, 3, 201, 6, 50, 65, 200, 192, 203, 113, 79,
        199, 225, 197, 114, 141, 23, 169, 246, 181, 166, 163, 38,
    ];
    ...
    static PROOF_OF_AGREEMENT_TYPEHASH: [u8; 32] = [
        185, 27, 12, 51, 75, 214, 207, 181, 70, 113, 59, 190, 184, 233, 248, 119, 28, 64, 225, 24,
        110, 118, 31, 55, 253, 52, 142, 191, 198, 65, 42, 150,
    ];
    ...
    mod tests {
        ...
        fn domain() -> EIP712Domain {
            EIP712Domain {
                ...
                chain_id: 1,
                verifying_contract: <[u8; 20]>::from_hex(
